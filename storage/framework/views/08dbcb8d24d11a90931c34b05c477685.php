    ...
    <div class="container m-4" style="font-size: 0.9rem;">
        <div class="row">
            <div class="col-md-6 d-flex m-auto bg-light p-5" style="border-radius: 10px; border:2px solid orange;">
                ...
                <form class="form col-md-12" action="<?php echo e(route('users.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\xampp\htdocs\banking_system\resources\views/account/create.blade.php ENDPATH**/ ?>