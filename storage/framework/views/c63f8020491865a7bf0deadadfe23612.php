    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="<?php echo e(route('users.index')); ?>" class="nav-link">Users Info</a>
                </li>
            </ul>
            <!-- Right navbar links -->
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(route('create_wdr')); ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Withdraw</p>
                                    </a>
                                </li>
...
</html><?php /**PATH D:\xampp\htdocs\banking_system\resources\views/layout/erp/app.blade.php ENDPATH**/ ?>